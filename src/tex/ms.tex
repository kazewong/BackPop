...
We use the "Overall_posterior" posterior samples for GW150914,
...
For events announced in GWTC-1, we use "Overall_posterior", "PublicationSamples","IMRPhenomXPHM_comoving" and "C01:Mixed" posterior samples, respectively.
...
We use the  Each contour represents

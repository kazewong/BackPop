...
properties is one of the principal ways to extract information about binary evolution
astrophysics from catalogs. Here we propose an inference pipeline to
simultaneously infer zero-age main sequence properties and population 
synthesis parameter settings controlling modeled binary

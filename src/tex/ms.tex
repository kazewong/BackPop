...
We use the \texttt{Overall_posterior} posterior samples for GW150914,
...
For events announced in GWTC-1, we use \texttt{Overall_posterior}, \texttt{PublicationSamples},\texttt{IMRPhenomXPHM_comoving} and \texttt{C01:Mixed} posterior samples, respectively.

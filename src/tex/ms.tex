...
fail in reproducing a subset of the event in GWTC-3. One example of this are GW events with at least one component
...
\begin{figure}
\includegraphics[width=0.49\textwidth]{figures/GWTC-3_f_acc_mass.pdf}
\caption{
...
Alternative channels such as dynamic formation channel will be needed to explain some subset of the events in GWTC-3 \citep{Zevin2021}.

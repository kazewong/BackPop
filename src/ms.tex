...
\kw{I think this can be very brief. Save the main explanation to the physics paper.}
...
For GW150914, the KL divergence between the reprojected posterior and the original posterior is \kw{fill later}logits on average if we use the root-finding result alone,
whereas the MCMC result has a higher KL divergence at \kw{fill} logits.

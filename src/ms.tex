...
simultaneously infer the posterior density of stellar progenitor parameters
(e.g. zero-age main sequence masses) and population synthesis parameter settings
controlling modeled binary evolution from gravitational wave observations.  Our
...
the third LIGO Virgo Kagra Gravitational Wave Transient Catalog (GWTC3).  We
showcase the effectiveness of this pipeline with a detailed study of the
progenitor properties and population synthesis settings that produce mergers
like the observed GW150914.
\end{abstract}
...
with the sensitivity of the ground-based GW detector network \citep{Abbott2018,LIGOScientificCollaboration2015,Buikema2020,Tse2019,Acernese2015,Acernese2019,Aso2013,Akutsu2021}, the ability to disentangle the astrophysical processes 

...
i = 0
data = h5py.File('../data/GW150914_roots_raw.hdf5')
processed_data = h5py.File('../data/GW150914_roots_processed.hdf5')
mcmc_processed = h5py.File('../data/GWTC3_mcmc_processed.hdf5','r')
...
percentile = [0.7,0.9]
corner.hist2d(m1_pred[()],m2_pred[()],weights=weight_array[0],color='C0',plot_density=False,labels='Root-finding',levels=percentile,plot_datapoints=False)
corner.hist2d(m1_pred_mcmc[()],m2_pred_mcmc[()],color='C1',plot_density=False,labels='MCMC',levels=percentile,plot_datapoints=False)
corner.hist2d(observables[i][:,0],observables[i][:,1],color='C2',plot_density=False,labels='Data',levels=percentile,plot_datapoints=False,)
...
plt.savefig('/mnt/home/wwong/GWProject/ProgenitorCatalogue/plots/GW150914_reprojection.pdf',dpi=300)
